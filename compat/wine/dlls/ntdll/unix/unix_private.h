...
extern void tuxblox_diag_bp_report(void);
...
extern void tuxblox_diag_stack_exec( const EXCEPTION_RECORD *rec, const CONTEXT *context );
extern void tuxblox_diag_dump_image( const char *why );
...
extern void tuxblox_diag_wpage_arm( void );
extern void tuxblox_diag_dump_ldr( void );
...
extern void tuxblox_diag_note_create_file( const OBJECT_ATTRIBUTES *attr, unsigned int status );
