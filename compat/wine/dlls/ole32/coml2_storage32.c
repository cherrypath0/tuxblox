/* The storage entry points ole32 used to import from coml2.dll.
 * Windows' ole32.dll does not import coml2.dll, so ours does not either;
 * this is coml2's dlls/coml2/storage32.c, built into ole32 instead. */
/*
