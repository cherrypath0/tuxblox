...
NTSYSAPI NTSTATUS  WINAPI NtChangeProcessState(HANDLE,HANDLE,ULONG,void*,SIZE_T,ULONG64);
...
NTSYSAPI NTSTATUS  WINAPI NtCreateJobSet(ULONG,void*,ULONG);
...
NTSYSAPI NTSTATUS  WINAPI RtlNtPathNameToDosPathName(ULONG,PRTL_UNICODE_STRING_BUFFER,ULONG*,PWSTR*);
