...
C_ASSERT( offsetof(struct get_process_handle_count_request, handle) == 12 );
C_ASSERT( sizeof(struct get_process_handle_count_request) == 16 );
C_ASSERT( offsetof(struct get_process_handle_count_reply, count) == 8 );
C_ASSERT( sizeof(struct get_process_handle_count_reply) == 16 );
C_ASSERT( offsetof(struct get_process_handle_table_request, handle) == 12 );
