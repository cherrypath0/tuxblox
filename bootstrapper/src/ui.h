...
// Owns SDL/ImGui resources and renders one frame of the bootstrapper
// window from `app`'s current snapshot. Returns false when the window should
// close (user closed it, cancelled, or dismissed the error).
class Ui {
public:
    Ui();
    ~Ui();
