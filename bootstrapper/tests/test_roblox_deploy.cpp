...
int main() {
    ...
    {
        assert(packageInstallSubdir("RobloxApp.zip", RobloxApp::Player) == "");
        assert(packageInstallSubdir("shaders.zip", RobloxApp::Player) == "shaders/");
        assert(packageInstallSubdir("ssl.zip", RobloxApp::Player) == "ssl/");
        assert(!packageInstallSubdir("SomeFutureUnknownPackage.zip", RobloxApp::Player).has_value());
        ...
        assert(packageInstallSubdir("WebView2.zip", RobloxApp::Player) == "");
        assert(packageInstallSubdir("RobloxStudio.zip", RobloxApp::Player) == "");
        assert(packageInstallSubdir("Libraries.zip", RobloxApp::Player) == "");
        assert(packageInstallSubdir("LibrariesQt5.zip", RobloxApp::Player) == "");
        assert(packageInstallSubdir("BuiltInStandalonePlugins.zip", RobloxApp::Player) ==
               "BuiltInStandalonePlugins/");
        assert(packageInstallSubdir("content-qt_translations.zip", RobloxApp::Player) ==
               "content/qt_translations/");
        assert(packageInstallSubdir("content-studio_svg_textures.zip", RobloxApp::Player) ==
               "content/studio_svg_textures/");
        assert(packageInstallSubdir("content-api-docs.zip", RobloxApp::Player) == "content/api_docs/");
        assert(packageInstallSubdir("content-platform-dictionaries.zip", RobloxApp::Player) ==
               "PlatformContent/pc/shared_compression_dictionaries/");
        assert(packageInstallSubdir("extracontent-scripts.zip", RobloxApp::Player) == "ExtraContent/scripts/");
        assert(packageInstallSubdir("studiocontent-models.zip", RobloxApp::Player) == "StudioContent/models/");
        assert(packageInstallSubdir("studiocontent-textures.zip", RobloxApp::Player) ==
        ...
        assert(!packageInstallSubdir("WebView2RuntimeInstaller.zip", RobloxApp::Player).has_value());
