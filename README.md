...
## Features
* **Easy Setup**: Just run the installer, it downloads everything you need, and the launcher auto-updates itself.
* **Fast Performance**: Near-instant startup, no waiting around for things to load.
* **Full Control**: Adjust Proton settings and environment variables straight from the launcher's Settings tab.

## System Requirements
### Hardware Requirements:
* **Processor:** 64-bit x86 (x86_64) Architecture with SSE3 Support
* **Storage Space:** 4 GB or higher
